...
var src_default = {
  async fetch(request, env) {
    ...
    if (!channel || typeof text !== "string" || !text.trim() || text.length > 4096 || !Number.isFinite(delay) || delay < 1 || delay > MAX_DELAY_SECONDS) {
...
// .wrangler/tmp/bundle-ZerggE/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-ZerggE/middleware-loader.entry.ts
